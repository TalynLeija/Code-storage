...
np.random.seed(5)
Previous_Lotto_numbers = np.random.randint(1,35,size=(data_size,List_size))
...
#Create data frame
df = pd.DataFrame(SB_Lotto_numbers,columns=list("ABCDEF"))
# print(Previous_Lotto_numbers[0])
...
window_length = 7 #amount of past games taken into consideration 2 or 7
